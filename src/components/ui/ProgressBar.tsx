...
export interface ProgressBarProps {
  ...
  color?: string;
  /** Accessible name; progress bars need one to be announced meaningfully. */
  label?: string;
}
...
export function ProgressBar({ percent, className, color, label = 'Progress' }: ProgressBarProps) {
