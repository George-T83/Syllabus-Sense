      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div
              className={`p-3 rounded-xl ${isOverCapacity ? 'bg-rose-500/20 text-rose-400' : 'bg-indigo-500/20 text-indigo-400'}`}
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-slate-900/60 border border-slate-800 rounded-xl px-3 py-1.5 min-h-[44px]">
            ...
            >
              ...
              <option value="club" className="bg-slate-900">
                Clubs & Orgs
              </option>
              ...
              <option value="athletics" className="bg-slate-900">
                Athletics
              </option>
              <option value="volunteering" className="bg-slate-900">
                Volunteering
              </option>
            </select>
          </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 py-2 border-y border-slate-800/80 text-xs">
                    ...
                    <div className="col-span-2 sm:col-span-1 flex items-center gap-1.5 text-slate-400">
                      <span
                        className={`w-2 h-2 rounded-full ${act.status === 'active' ? 'bg-emerald-400' : act.status === 'paused' ? 'bg-amber-400' : 'bg-slate-500'}`}
                      />
                      ...
                      {act.milestones.map((m) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={`text-xs font-medium ${m.completed ? 'line-through text-slate-500' : 'text-slate-200'}`}
                            >
                              {m.title}
                            </span>
                          </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div
                          className={`text-xs font-semibold ${milestone.completed ? 'line-through text-slate-500' : 'text-white'}`}
                        >
                          {milestone.title}
                        </div>
