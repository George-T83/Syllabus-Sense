...
export function ContactShareModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-lg rounded-3xl bg-slate-900 border border-slate-800 p-6 sm:p-7 shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-start justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="contact-share-modal-title" className="text-lg font-bold text-white">
                Share Contact Card
              </h3>
        ...
        <div className="rounded-2xl bg-slate-950/60 border border-slate-800 p-4 space-y-2">
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <h4 className="text-base font-bold text-white">{contact.fullName}</h4>
          ...
          {contact.title && (
            <p className="text-xs text-slate-300">{contact.title}</p>
          )}
        ...
        <div className="flex items-center rounded-xl bg-slate-950 p-1 border border-slate-800">
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-xs font-semibold transition-all cursor-pointer min-h-[38px] ${
              activeTab === 'qr'
        ...
        {activeTab === 'qr' ? (
          ...
          <div className="space-y-2">
            ...
            <pre
              ...
              className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 text-[11px] font-mono text-slate-300 overflow-x-auto whitespace-pre-wrap max-h-48"
            >
              {vcardText}
            </pre>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold transition-all shadow-lg shadow-indigo-600/20 active:scale-95 cursor-pointer min-h-[44px]"
          >
          ...
          {mailtoLink ? (
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-semibold transition-colors cursor-pointer min-h-[44px]"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            ...
            <button
              disabled
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-slate-800/40 text-slate-500 text-xs font-semibold min-h-[44px] cursor-not-allowed"
            >
              No Email
            </button>
          )}
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-semibold transition-colors cursor-pointer min-h-[44px]"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
