/**
 * Shared SVG path data for section-heading icon badges (SectionIcon), so
 * every page draws from one icon set instead of each redefining its own
 * slightly-different copies of the same glyphs.
 */
export const ICON_PATHS = {
  ...
  syllabus:
    'M9 13h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
